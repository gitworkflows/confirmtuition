                    ...
                    <table id="data-table-default" class="table table-striped table-bordered table-td-valign-middle table-responsive">
                        ...
                        <tbody>
                            ...
                            <tr class="odd gradeX">
                                ...
                                <td>@if($row->tutoring_time){{date('h:i a', strtotime($row->tutoring_time))}}@else --- @endif</td>
                                ...
                                <td>
                                    <a href="{{url('admin/jobs/new')}}?id={{$row->id}}" class="mb-1 btn btn-primary btn-xs"> Edit</a>
                                    <a href="{{url('admin/application',$row->id)}}" class="mb-1 btn btn-danger btn-xs"> Delete</a>
                                </td>
                            </tr>
                            @endforeach
                        </tbody>
