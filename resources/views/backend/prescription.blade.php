                    ...
                    <table id="data-table-default" class="table table-striped table-bordered table-td-valign-middle">
                        ...
                        <tbody>
                            ...
                            <tr class="odd gradeX">
                                ...
                                <td>
                                    <a id="delete" href="@if(!empty($row->file)) {{asset($row->file)}} @else {{asset('defaults/noimage/no_img.jpg')}} @endif" class="btn btn-primary btn-xs"><i class="fa fa-download"></i> Download</a>
                                </td>
                            </tr>
                            @endforeach
                        </tbody>
