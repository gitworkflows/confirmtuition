...
jQuery(window).on("load", function () {
    ...
    jQuery(".tu-show_more").on("click", function () {
        jQuery(this).text(
            $(this).text() === "Show less" ? "Show all" : "Show less"
        );
        jQuery(this)
            .closest(".tu-asideitem")
            .find(".tu-categorieslist li:nth-child(n+7)")
            .slideToggle();
        jQuery(this)
            .closest(".tu-asideitem")
            .find(".tu-collapseitem .tu-commenteditem:nth-child(n+6)")
            .slideToggle();
        jQuery(this)
            .closest(".tu-aside-content")
            .find(".tu-filterselect li:nth-child(n+7)")
            .slideToggle();
        jQuery(this)
            .closest(".tu-tabswrapper")
            .find(".tu-commentarea .tu-commentlist:nth-child(n+5)")
            .slideToggle();
        jQuery(this)
            .closest(".tu-boxlg")
            .find(".tu-commentarea .tu-commentlist:nth-child(n+5)")
    ...
    jQuery("[data-placeholderinput]").each(function (item) {
        ...
        var tu_placeholder = jQuery(data_placeholder).attr(
            "data-placeholderinput"
        );
    ...
    // remove
    jQuery(".tu-searchtags li span a, .tu-labels li span a").on(
        "click",
        function () {
    ...
    function collapseMenu() {
        jQuery(".menu-item-has-children > a,.menu-item-has-children strong").on(
            "click",
            function () {
